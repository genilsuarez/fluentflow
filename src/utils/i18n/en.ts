...
export const en = {
  common: {
    ...
    searchModules: 'Search exercises...',
    searchLabel: 'Search learning exercises',
    searchDescription: 'Search exercises by name, category, or topic',
  ...
  mainMenu: {
    ...
    allModules: 'Exercises',
    progressViewLabel: 'Progression view',
    listViewLabel: 'List view',
    showingResults: '{{count}} of {{total}} exercises',
    clearFilters: 'Clear',
    noModulesFound: 'No exercises found for "{{query}}"',
    searchHint: 'Try adjusting your search terms or browse all available exercises.',
    retryLoading: 'Retry loading exercises',
    tryAgain: 'Try Again',
    modulesAvailable: '{{count}} learning exercises available',
    ...
    connectionErrorDesc: 'Could not load exercises. Check your connection.',
    retryAction: 'Retry',
  ...
  navigation: {
    ...
    headerHomeSub: '{{total}} exercises · CEFR A1–C2',
    headerModulesSub: '{{count}} learning exercises available',
    dashboard: 'Dashboard',
    settings: 'Settings',
    profile: 'Profile',
    help: 'Help',
  ...
  auth: {
    ...
    goToMainMenu: 'Go to main exercises menu',
    viewProgressDashboard: 'View complete progress and statistics dashboard',
    viewLearningPath: 'View exercise progression and learning path',
  ...
  modals: {
    ...
    learningPathDesc: 'Progress by levels and available exercises',
  ...
  settings: {
    ...
    decreaseDictationCount: 'Decrease dictation count',
    increaseDictationCount: 'Increase dictation count',
    listenCompleteMode: 'Listen & Fill',
    decreaseListenCompleteCount: 'Decrease listen & fill count',
    increaseListenCompleteCount: 'Increase listen & fill count',
    listeningQuizMode: 'Listen Quiz',
    decreaseListeningQuizCount: 'Decrease listen quiz count',
    increaseListeningQuizCount: 'Increase listen quiz count',
  },
  about: {
    ...
    feature1: '10 learning modes · 276 exercises',
  ...
  learning: {
    ...
    noReorderingExercisesAvailable: 'No reordering exercises available.',
    ...
    fillBlankArticles: 'Fill the blanks. Leave empty when no article is needed.',
    fillBlankMulti: 'Fill every blank, then press Enter.',
    fillBlankNoHint: 'Type your answer — no letter hints in the blank.',
    blankLabel: 'Blank {{current}} of {{total}}',
    noArticle: 'none',
    pressEnterNext: 'Press Enter for next exercise',
    listenAndType: 'Listen and type what you hear',
    listenAndFillBlank: 'Listen, then fill in the blank',
    listenAndChoose: 'Listen and choose the correct answer',
  ...
  dashboard: {
    ...
    recentActivity: 'Recent days',
    modulePerformance: 'Module Performance',
    learningAccuracy: 'Accuracy',
    studySessions: 'Sessions',
    noProgressData: 'No data yet',
    noModuleData: 'No exercises completed',
    completeModulesMessage: 'Complete exercises to see progress!',
    helpButton: 'Help',
    ...
    depthTo: 'to',
    viewAll: 'View all',
    smallSteps: 'Small steps, big wins',
    levelPathSub: 'Your learning path, step by step',
    recentActivitySub: 'Your recent activity',
    activityEmptySub: 'Your activity from the last few days will show up here.',
  ...
  categoryFilter: {
    ...
    dependencyWarning: 'Requires exercises from {{categories}}',
  },
  modeFilter: {
  ...
  profile: {
    ...
    statScore: 'Score',
    statModules: 'Exercises',
    statStreak: 'Streak',
    statAvg: 'Average',
    noActivityYet: 'Complete exercises to see your stats here',
  },
  learningPath: {
    complete: 'Complete',
    completed: 'Completed',
    ...
    completedModules: 'exercises',
    availableModules: 'exercises',
    lockedModules: 'exercises',
  },
  orientation: {
  ...
  errors: {
    ...
    errorLoadingModules: 'Error loading exercises',
  ...
  offline: {
    ...
    deleteLevelConfirmTitle: 'Delete Level',
